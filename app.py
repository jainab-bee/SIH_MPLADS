...
/* Section Titles — HIGH CONTRAST & VISIBLE IN ALL THEMES */
.section-title{
...
/* KPI Cards — High contrast dark slate */
.kpi-card{
...
/* Disclaimers & Info Boxes — SOLID DARK SLATE FOR 100% CONTRAST IN LIGHT & DARK MODES */
.disclaimer{
    background:#0f172a !important;
...
.disclaimer strong{color:#38bdf8 !important;}
...
def main ():
    ...
    elif page =="🔍 Project Detail":page_project_detail (filtered_fdf ,similar_map )
    ...
    elif page =="💬 Citizen Feedback":page_citizen_feedback (fdf )
    elif page =="🌐 Transparency Portal":page_transparency_portal (df )
