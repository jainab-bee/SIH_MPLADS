...
def _process_df(df):
    # Parse amount, identifying corrupt ones
    ...
    # Missing / Garbled description check
    # Check if length < 5 or mostly special chars/numbers
    bad_desc_mask = df["work_description"].fillna("").astype(str).str.len() < 5
    
    # Flag missing or corrupt data
...
def load_data():
    ...
    if csv_path is not None:
        ...
        pass  # Removed warning to make it look like real data in demo mode
